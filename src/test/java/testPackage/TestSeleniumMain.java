...
public class TestSeleniumMain {
	...
	public static void main(String[] args) {
		// System.setProperty("webdriver.chrome.driver","C:\\Users/showkotakbor/eclipse-workspace/com.CapitalOneBank.QA/Driver/chromedriver
		// 2");
		WebDriverManager.chromedriver().setup();
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.capitalone.com/bank/");
